...
extension JSExecutionTests {
    ...
    func testProperty() {
        ...
        let property = JSProperty<String>(variableName: "tester", "title")
    ...
    func testSuccessReturnValue() {
        ...
        let method = JSMethod<Bool>(variableName: "tester", "refresh")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testVoidSuccessValue() {
        ...
        let method = JSMethod<Void>(variableName: "tester", "clearQueue")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testExpectedError() {
        ...
        let method = JSMethod<Void>(variableName: "yolo", "refresh")
        let resultExpectation = expectation(description: "Async execution callback is called")
...
extension JSExecutionTests {
    ...
    func testHandleUnexpectedReturnValue() {
        ...
        let method = JSMethod<Void>(variableName: "tester", "refresh")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testInvalidReturnValue() {
        ...
        let method = JSMethod<String>(variableName: "tester", "refresh")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testMissingReturnValue() {
        ...
        let method = JSMethod<Bool>(variableName: "tester", "clearQueue")
        let resultExpectation = expectation(description: "Async execution callback is called")
...
extension JSExecutionTests {
    ...
    func testDecodeString() {
        ...
        let method = JSMethod<String>(variableName: "tester", "testString")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeNumber() {
        ...
        let method = JSMethod<Int8>(variableName: "tester", "testNumber")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeBool() {
        ...
        let method = JSMethod<Bool>(variableName: "tester", "testBool")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeValidRawRepresentable() {
        ...
        let method = JSMethod<MockTargetType>(variableName: "tester", "testValidMockTargetType")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidRawRepresentable() {
        ...
        let method = JSMethod<MockTargetType>(variableName: "tester", "invalidTestMockTargetRawType")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeObject() {
        ...
        let method = JSMethod<MockTarget>(variableName: "tester", "testTarget")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidObject() {
        ...
        let method = JSMethod<MockTarget>(variableName: "tester", "invalidTestTarget")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidObjectPrototype() {
        ...
        let method = JSMethod<MockTarget>(variableName: "tester", "invalidTestTargetPrototype")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeArrayOfPrimitives() {
        ...
        let method = JSMethod<[UInt16]>(variableName: "tester", "testPrimitivesArray")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidArrayOfPrimitives() {
        ...
        let method = JSMethod<[UInt16]>(variableName: "tester", "testInvalidPrimitivesArray")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidMixedArrayOfPrimitives() {
        ...
        let method = JSMethod<[String]>(variableName: "tester", "testInvalidMixedPrimitivesArray")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeArrayOfRawRepresentable() {
        ...
        let method = JSMethod<[MockTargetType]>(variableName: "tester", "testMockTargetTypes")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidArrayOfRawRepresentable() {
        ...
        let method = JSMethod<[MockTargetType]>(variableName: "tester", "testInvalidMockTargetTypes")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidRawTypesArray() {
        ...
        let method = JSMethod<[MockTargetType]>(variableName: "tester", "testInvalidRawMockTargetTypes")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeUnknownRawValue() {
        ...
        let method = JSMethod<[MockTargetType]>(variableName: "tester", "testUnknownRawMockTargetTypes")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeArrayOfObjects() {
        ...
        let method = JSMethod<[MockTarget]>(variableName: "tester", "testObjects")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidArrayOfObjects() {
        ...
        let method = JSMethod<[MockTarget]>(variableName: "tester", "testInvalidObjects")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidObjectContainingArray() {
        ...
        let method = JSMethod<[MockTarget]>(variableName: "tester", "textMixedObjects")
        let resultExpectation = expectation(description: "Async execution callback is called")
    ...
    func testDecodeInvalidObjectPrototypeContainingArray() {
        ...
        let method = JSMethod<[MockTarget]>(variableName: "tester", "textDifferentObjectPrototypes")
        let resultExpectation = expectation(description: "Async execution callback is called")
